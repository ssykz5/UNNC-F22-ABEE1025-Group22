...
class DataPlotting(tk.Tk):
    def __init__(self):
        ...
        self.p_control = tk.PanedWindow(self, orient=tk.VERTICAL, bg='#FF9800')
        ...
        output_choose_dir_btn.pack(fill=tk.NONE, side=tk.LEFT, padx=20, pady=20)

        # Initialize the analysis name.
        self.analysis_name = tk.StringVar()
        self.analysis_name.set("New Analysis")
        # Create analysis button
        create_analysis_btn = tk.Button(self.p_create, text="Create Analysis", command=self.initialize_analysis, bg="#FF9800", fg="#212121", font=('Times', 10, 'bold'))
        ...
        add_outdoor_temp_btn = tk.Button(self.p_outdoor, text="Add Outdoor Temperature datas into the Analysis", command=self.add_outdoor_temperature_df, bg="#FF9800", fg="#FFE0B2", font=('Times', 10, 'bold'))
        add_outdoor_temp_btn.pack(fill=tk.NONE, side=tk.LEFT, padx=20, pady=20)
        ...
        # Showing start date.
        start_date_indicator = tk.Label(self.p_dt_start, text="Start Date:", bg="#FF9800", fg="#757575", font=('Times', 15, 'bold'))
        start_date_indicator.pack(fill=tk.NONE, side=tk.LEFT, padx=20, pady=20)
        start_date_label = tk.Label(self.p_dt_start, textvariable=self.start_date, bg="#FF9800", fg="#FFF9C4", font=('Times', 13, 'bold'))
        start_date_label.pack(fill=tk.NONE, side=tk.LEFT, padx=20, pady=20)
        # Showing start time.
        start_time_indicator = tk.Label(self.p_dt_start, text="Start time:", bg="#FF9800", fg="#757575", font=('Times', 15, 'bold'))
        start_time_indicator.pack(fill=tk.NONE, side=tk.LEFT, padx=20, pady=20)
        start_time_label = tk.Label(self.p_dt_start, textvariable=self.start_time, bg="#FF9800", fg="#FFF9C4", font=('Times', 13, 'bold'))
        start_time_label.pack(fill=tk.NONE, side=tk.LEFT, padx=20, pady=20)
        # Choose start date and time.
        start_date_btn = tk.Button(self.p_dt_start, text="Choose start date & time", command=self.choose_start_date_and_time, bg="#FF9800", fg="#FFF9C4", font=('Times', 10, 'bold'))
        start_date_btn.pack(fill=tk.NONE, side=tk.LEFT, padx=20, pady=20)
        ...
        # Showing end date.
        end_date_indicator = tk.Label(self.p_dt_end, text="End Date:", bg="#FF9800", fg="#757575", font=('Times', 15, 'bold'))
        end_date_indicator.pack(fill=tk.NONE, side=tk.LEFT, padx=20, pady=20)
        end_date_label = tk.Label(self.p_dt_end, textvariable=self.end_date, bg="#FF9800", fg="#FFF9C4", font=('Times', 13, 'bold'))
        end_date_label.pack(fill=tk.NONE, side=tk.LEFT, padx=20, pady=20)
        # Showing start time.
        end_time_indicator = tk.Label(self.p_dt_end, text="End time:", bg="#FF9800", fg="#757575", font=('Times', 15, 'bold'))
        end_time_indicator.pack(fill=tk.NONE, side=tk.LEFT, padx=20, pady=20)
        end_time_label = tk.Label(self.p_dt_end, textvariable=self.end_time, bg="#FF9800", fg="#FFF9C4", font=('Times', 13, 'bold'))
        end_time_label.pack(fill=tk.NONE, side=tk.LEFT, padx=20, pady=20)
        # Choose start date and time.
        end_date_btn = tk.Button(self.p_dt_end, text="Choose end date & time", command=self.choose_end_date_and_time, bg="#FF9800", fg="#FFF9C4", font=('Times', 10, 'bold'))
        ...
        plot_each_day_btn = tk.Button(self.p_plot, text="Plot Temperature vs Time in different date", command=self.plotting_each_day, bg="#FF9800", fg="#212121", font=('Times', 10, 'bold'))
        plot_each_day_btn.pack(fill=tk.NONE, side=tk.RIGHT, padx=20, pady=20, anchor="center")
        plot_average_btn = tk.Button(self.p_plot, text="Plot Day Average Temperature vs Date", command=self.plotting_average, bg="#FF9800", fg="#212121", font=('Times', 10, 'bold'))
        plot_average_btn.pack(fill=tk.NONE, side=tk.RIGHT, padx=20, pady=20, anchor="center")
        ...
        reco_each_day_btn = tk.Button(self.p_reco, text="Plot Temperature vs Time in different date with recommended range", command=self.plotting_each_day_with_reco, bg="#FF9800", fg="#212121", font=('Times', 10, 'bold'))
        reco_each_day_btn.pack(fill=tk.NONE, side=tk.RIGHT, padx=20, pady=20, anchor="center")
        reco_average_btn = tk.Button(self.p_reco, text="Plot Day Average Temperature vs Date with recommended range", command=self.plotting_average_with_reco, bg="#FF9800", fg="#212121", font=('Times', 10, 'bold'))
